...
if len(sys.argv) !=2:
  print "Usage !! python2 dc_static_route.py asw_static_route.cfg"
  print "see the sample asw_static_route.cfg file for data input"
  sys.exit()
...
for i in fdata:
  ...
  if len(i)>=5:
    #print i
    i['process']=multiprocessing.Process(target=static_route.STATIC, args=(i,))
